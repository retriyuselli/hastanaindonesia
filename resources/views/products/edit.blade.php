            ...
            <div class="bg-white rounded-lg shadow-md p-6 md:p-8">
                ...
                <form action="{{ route('products.update', [$weddingOrganizer->slug, $product->id]) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="features" id="features" rows="6" placeholder="Satu item per baris (contoh: Dekorasi premium, Tim WO, Dokumentasi foto/video)" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('features', is_array($product->features) ? implode("\n", $product->features) : $product->features) }}</textarea>
