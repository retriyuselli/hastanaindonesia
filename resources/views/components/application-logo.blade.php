<div {{ $attributes->merge(['class' => 'flex items-center justify-center']) }}>
    ...
    <div class="flex items-center space-x-3">
        <!-- Logo Icon -->
        <div class="relative">
            <div class="w-12 h-12 bg-gradient-to-br from-gray-900 to-red-600 rounded-full flex items-center justify-center shadow-lg">
            ...
            <div class="absolute -inset-1 bg-gradient-to-r from-gray-700 to-red-600 rounded-full opacity-20"></div>
        </div>
