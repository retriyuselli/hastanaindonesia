...
@section('description', 'Organisasi resmi yang menaungi para wedding organizer profesional di Indonesia. Mendukung
    profesionalisme dan kolaborasi WO di seluruh Indonesia.')
...
@section('content')
    ...
    <section class="hero-bg min-h-screen flex items-center justify-center relative overflow-hidden">
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
            <div class="floating-animation">
                <div class="mb-8">
                    <div
                        class="w-24 h-24 bg-gradient-to-br from-blue-500 to-red-500 rounded-full flex items-center justify-center mx-auto mb-6 shadow-2xl">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center items-center">
                    <a href="{{ route('members') }}"
                        class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white text-sm font-semibold rounded-full hover:from-blue-700 hover:to-blue-800 transition-all duration-300 shadow-xl hover:shadow-2xl transform hover:-translate-y-1">
                        <i class="fas fa-users mr-2 text-xs"></i>
                        Lihat Daftar Anggota
                    </a>
                    <a href="{{ route('join') }}"
                        class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-red-600 to-red-700 text-white text-sm font-semibold rounded-full hover:from-red-700 hover:to-red-800 transition-all duration-300 shadow-xl hover:shadow-2xl transform hover:-translate-y-1">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="card-hover bg-white p-6 rounded-2xl shadow-lg text-center">
                    <div
                        class="w-14 h-14 bg-gradient-to-br from-blue-600 to-blue-700 rounded-2xl flex items-center justify-center mx-auto mb-4">
                ...
                <div class="card-hover bg-white p-6 rounded-2xl shadow-lg text-center">
                    <div
                        class="w-14 h-14 bg-gradient-to-br from-red-600 to-red-700 rounded-2xl flex items-center justify-center mx-auto mb-4">
                ...
                <div class="card-hover bg-white p-6 rounded-2xl shadow-lg text-center">
                    <div
                        class="w-14 h-14 bg-gradient-to-br from-gray-700 to-gray-800 rounded-2xl flex items-center justify-center mx-auto mb-4">
                ...
                <div class="card-hover bg-white p-6 rounded-2xl shadow-lg text-center">
                    <div
                        class="w-14 h-14 bg-gradient-to-br from-purple-600 to-purple-700 rounded-2xl flex items-center justify-center mx-auto mb-4">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div>
                    ...
                    <div class="prose text-gray-600 leading-relaxed space-y-4">
                        <p>
                            <strong>Himpunan Perusahaan Penata Acara Seluruh Indonesia (HASTANA)</strong> adalah organisasi
                            resmi yang menaungi para wedding organizer profesional di seluruh Indonesia. Kami berkomitmen
                            untuk meningkatkan standar kualitas industri pernikahan Indonesia melalui sertifikasi,
                            pelatihan, dan kolaborasi antar profesional.
                        </p>
                        <p>
                            Dengan jaringan yang tersebar di berbagai kota besar Indonesia, HASTANA menjadi wadah bagi para
                            wedding organizer untuk saling berbagi pengalaman, mengembangkan skill, dan memberikan pelayanan
                            terbaik bagi pasangan yang ingin merayakan hari istimewa mereka.
                        </p>
                        <p>
                            Misi kami adalah menciptakan ekosistem wedding organizer yang profesional, terpercaya, dan
                            inovatif, sehingap setiap pernikahan di Indonesia dapat diselenggarakan dengan standar
                            internasional.
                        </p>
                    </div>
                    ...
                    <div class="mt-8 flex flex-col sm:flex-row gap-3">
                        <a href="{{ route('about') }}"
                            class="inline-flex items-center px-5 py-2.5 border-2 border-hastana-blue text-hastana-blue font-semibold text-sm rounded-full hover:bg-hastana-blue hover:text-white transition-all duration-300">
                            <i class="fas fa-info-circle mr-2 text-xs"></i>
                            Selengkapnya
                        </a>
                        <a href="{{ route('contact') }}"
                            class="inline-flex items-center px-5 py-2.5 text-gray-600 font-semibold text-sm hover:text-hastana-blue transition-colors duration-300">
                ...
                <div class="relative">
                    <div
                        class="aspect-square bg-gradient-to-br from-blue-100 to-red-100 rounded-3xl flex items-center justify-center">
                        <div class="text-center">
                            <div
                                class="w-28 h-28 bg-gradient-to-br from-blue-600 to-red-600 rounded-full flex items-center justify-center mx-auto mb-5">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
                ...
                @forelse($featuredWeddingOrganizers->take(8) as $index => $wo)
                    ...
                    <a href="{{ route('members.show', $wo->slug) }}"
                        class="card-hover bg-white p-5 rounded-2xl shadow-lg border border-gray-100 text-center block transition-all duration-300">
                        <!-- Logo or Icon -->
                        @if ($wo->logo)
                            <div
                                class="w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-3 overflow-hidden border-2 border-gray-100">
                                <img src="{{ asset('storage/' . $wo->logo) }}" alt="{{ $wo->brand_name }}"
                                    class="w-full h-full object-cover">
                            </div>
                        @else
                            <div
                                class="w-16 h-16 bg-gradient-to-br {{ $gradient[0] }} {{ $gradient[1] }} rounded-full flex items-center justify-center mx-auto mb-3">
            ...
            <div class="text-center">
                <a href="{{ route('members') }}"
                    class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-gray-800 to-gray-900 text-white font-semibold text-sm rounded-full hover:from-gray-900 hover:to-black transition-all duration-300 shadow-lg hover:shadow-xl">
                    <i class="fas fa-users mr-2 text-xs"></i>
                    Lihat Semua Anggota
                </a>
            </div>
    ...
    <section class="py-16 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                @forelse($upcomingEvents as $index => $event)
                    ...
                    <div class="card-hover bg-white rounded-2xl overflow-hidden shadow-lg">
                        <div class="aspect-video overflow-hidden">
                            ...
                            @else
                                <div
                                    class="w-full h-full bg-gradient-to-br from-{{ $buttonColor }}-500 to-{{ $buttonColor }}-600 flex items-center justify-center">
                        ...
                        <div class="p-6">
                            ...
                            <h3 class="text-sm font-bold text-gray-900 mb-2 truncate" title="{{ $event->title }}">
                                {{ $event->title }}</h3>
                            <p class="text-xs text-gray-600 mb-4 leading-relaxed">
                                {{ Str::limit($event->short_description ?? $event->description, 50) }}
                            </p>
                            <a href="{{ route('events.show', $event->slug) }}"
                                class="inline-flex items-center text-{{ $buttonColor }}-600 font-semibold text-xs hover:text-{{ $buttonColor }}-700 transition-colors">
                                Daftar
                ...
                @empty
                    ...
                    @for ($i = 0; $i < 4; $i++)
                        @php
                            ...
                            $eventLocations = ['Jakarta', 'Bali', 'Bandung', 'Surabaya'];
                            $eventDescriptions = [
                        ...
                        <div class="card-hover bg-white rounded-2xl overflow-hidden shadow-lg">
                            <div class="aspect-video overflow-hidden">
                                <img src="{{ $imageUrls[$i] }}" alt="{{ $eventTitles[$i] }}"
                                    class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300"
                                    loading="lazy">
                            </div>
                            <div class="p-6">
                                ...
                                <h3 class="text-sm font-bold text-gray-900 mb-2 truncate" title="{{ $eventTitles[$i] }}">
                                    {{ $eventTitles[$i] }}</h3>
                                <p class="text-xs text-gray-600 mb-4 leading-relaxed">
                                    {{ $eventDescriptions[$i] }}
                                </p>
            ...
            <div class="text-center">
                <a href="#events"
                    class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-purple-600 to-purple-700 text-white font-semibold text-sm rounded-full hover:from-purple-700 hover:to-purple-800 transition-all duration-300 shadow-lg hover:shadow-xl">
    ...
    <section class="py-16 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
                @forelse($latestBlogs as $blog)
                    <a href="{{ route('blog.detail', $blog->slug) }}"
                        class="card-hover bg-white rounded-2xl overflow-hidden shadow-lg border border-gray-100 block">
                        <div class="aspect-video overflow-hidden">
                    ...
                    @foreach ($data['latest_articles'] as $article)
                        <div class="card-hover bg-white rounded-2xl overflow-hidden shadow-lg border border-gray-100">
                            ...
                            <div class="p-5">
                                ...
                                <a href="#blog"
                                    class="text-blue-600 font-semibold text-xs hover:text-blue-700 transition-colors">
                                    Baca Selengkapnya →
                                </a>
                            </div>
                        </div>
            ...
            <div class="text-center">
                <a href="{{ route('blog') }}"
                    class="inline-flex items-center px-6 py-3 border-2 border-gray-800 text-gray-800 font-semibold text-sm rounded-full hover:bg-gray-800 hover:text-white transition-all duration-300">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center mb-12">
                <div class="flex items-center justify-center mb-5">
                    <div
                        class="w-14 h-14 bg-gradient-to-br from-blue-500 to-red-500 rounded-full flex items-center justify-center shadow-lg">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <!-- Gallery Item 1 -->
                <div
                    class="gallery-item relative group cursor-pointer overflow-hidden rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300">
            ...
            <div class="text-center mt-12">
                <a href="{{ route('gallery') }}"
                    class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-600 to-red-600 text-white font-bold text-sm rounded-full hover:from-blue-700 hover:to-red-700 transition-all duration-300 shadow-xl hover:shadow-2xl transform hover:-translate-y-1">
    ...
    <section class="py-16 bg-gradient-to-r from-gray-900 via-blue-900 to-red-900">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 class="text-3xl md:text-4xl font-bold text-white mb-5">
                Siap Bergabung dengan <span
                    class="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-red-400">HASTANA</span>?
            </h2>
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="#join"
                    class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white font-bold text-sm rounded-full hover:from-blue-700 hover:to-blue-800 transition-all duration-300 shadow-xl hover:shadow-2xl transform hover:-translate-y-1">
                    <i class="fas fa-user-plus mr-2 text-xs"></i>
                    Daftar Keanggotaan
                </a>
                <a href="#contact"
                    class="inline-flex items-center px-6 py-3 border-2 border-white text-white font-bold text-sm rounded-full hover:bg-white hover:text-gray-900 transition-all duration-300">
