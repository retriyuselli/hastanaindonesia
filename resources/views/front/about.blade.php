    ...
    <div class="container mx-auto px-4">
        ...
        <div class="mb-20">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <!-- Profesionalisme -->
                <x-ui.card class="p-6 text-center card-hover">
                    <div class="w-16 h-16 bg-gradient-to-br from-blue-500 to-blue-600 rounded-full flex items-center justify-center mx-auto mb-4">
                        <i class="fas fa-medal text-white text-2xl"></i>
                    </div>
                    <h4 class="text-xl font-bold text-gray-900 mb-3">Profesionalisme</h4>
            ...
            <div class="container mx-auto px-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    <div class="text-center">
                        <div class="text-4xl md:text-5xl font-bold text-hastana-blue mb-2">1000+</div>
                        <div class="text-gray-600 font-medium">Anggota Tersertifikasi</div>
                    </div>
                    <div class="text-center">
                        <div class="text-4xl md:text-5xl font-bold text-hastana-red mb-2">34</div>
                        <div class="text-gray-600 font-medium">Provinsi Terjangkau</div>
                    </div>
                    <div class="text-center">
                        <div class="text-4xl md:text-5xl font-bold text-hastana-blue mb-2">15+</div>
                        <div class="text-gray-600 font-medium">Tahun Pengalaman</div>
                    </div>
                    <div class="text-center">
                        <div class="text-4xl md:text-5xl font-bold text-hastana-red mb-2">50,000+</div>
                        <div class="text-gray-600 font-medium">Pernikahan Tersukseskan</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="mb-20">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <x-ui.card class="p-8 text-center card-hover">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-4">Sertifikasi Profesional</h3>
                ...
                <x-ui.card class="p-8 text-center card-hover">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-4">Pelatihan & Workshop</h3>
                    <p class="text-gray-600 leading-relaxed mb-6">
                ...
                <x-ui.card class="p-8 text-center card-hover">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-4">Networking & Kolaborasi</h3>
                    <p class="text-gray-600 leading-relaxed mb-6">
