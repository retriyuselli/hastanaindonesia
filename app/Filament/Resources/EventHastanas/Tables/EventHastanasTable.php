...
namespace App\Filament\Resources\EventHastanas\Tables;
        ...
        return $table
            ->columns([
                ...
                TextColumn::make('title')
                    ...
                    ->description(fn ($record): ?string => $record->slug ? '🔗 '.$record->slug : null
                    )
                    ->copyable()
                ...
                TextColumn::make('city')
                    ...
                    ->limit(30)
                    ->tooltip(fn ($record): ?string => $record->venue && strlen($record->venue) > 30 ? $record->venue : null
                    ),
                ...
                TextColumn::make('price')
                    ...
                    ->money('IDR')
                    ->sortable()
                    ->formatStateUsing(fn ($record): string => $record->is_free ? 'GRATIS' : 'Rp '.number_format($record->price, 0, ',', '.')
                    )
                ...
                TextColumn::make('organizer_name')
                    ...
                    ->searchable()
                    ->toggleable(isToggledHiddenByDefault: true)
                    ->description(fn ($record): string => $record->contact_email ?? $record->contact_phone ?? ''
                    ),
            ...
            ->recordActions([
                ActionGroup::make([
                    ...
                    Action::make('toggleFeatured')
                        ...
                        ->modalDescription(fn ($record): string => $record->is_featured
