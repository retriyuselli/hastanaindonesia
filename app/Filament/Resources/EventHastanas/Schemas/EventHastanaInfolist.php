...
namespace App\Filament\Resources\EventHastanas\Schemas;
        ...
        return $schema
            ...
            ->components([
                ...
                TextEntry::make('current_participants')
                    ...
                    ->formatStateUsing(fn ($record): string => number_format($record->current_participants).' / '.number_format($record->max_participants ?? $record->quota)
                    )
                ...
                TextEntry::make('rating')
                    ->label('Rating')
                    ->formatStateUsing(fn ($state): string => $state > 0 ? number_format($state, 1).' / 5.0' : 'Belum ada rating'
                    )
