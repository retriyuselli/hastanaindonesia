...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | List of cities and regencies (kabupaten) in Indonesia grouped by province.
    |
    */
    'cities' => [
        'Aceh' => [
        ...
        'Sumatera Utara' => [
            'Medan', 'Binjai', 'Pematangsiantar', 'Tebing Tinggi', 'Tanjung Balai', 'Padang Sidempuan', 'Gunungsitoli', 'Sibolga',
            'Kab. Asahan', 'Kab. Batubara', 'Kab. Dairi', 'Kab. Deli Serdang', 'Kab. Humbang Hasundutan', 'Kab. Karo',
            'Kab. Labuhanbatu', 'Kab. Labuhanbatu Selatan', 'Kab. Labuhanbatu Utara', 'Kab. Langkat', 'Kab. Mandailing Natal',
            'Kab. Nias', 'Kab. Nias Barat', 'Kab. Nias Selatan', 'Kab. Nias Utara', 'Kab. Padang Lawas', 'Kab. Padang Lawas Utara',
            'Kab. Pakpak Bharat', 'Kab. Samosir', 'Kab. Serdang Bedagai', 'Kab. Simalungun', 'Kab. Tapanuli Selatan',
            'Kab. Tapanuli Tengah', 'Kab. Tapanuli Utara', 'Kab. Toba Samosir',
        ],
        'Sumatera Barat' => [
            'Padang', 'Bukittinggi', 'Payakumbuh', 'Solok', 'Padang Panjang', 'Sawahlunto', 'Pariaman',
        ...
        'Lampung' => [
            ...
            'Kab. Mesuji', 'Kab. Pesawaran', 'Kab. Pesisir Barat', 'Kab. Pringsewu', 'Kab. Tanggamus', 'Kab. Tulang Bawang',
        ...
        'Nusa Tenggara Barat' => [
            'Mataram', 'Bima',
            'Kab. Bima', 'Kab. Dompu', 'Kab. Lombok Barat', 'Kab. Lombok Tengah', 'Kab. Lombok Timur', 'Kab. Lombok Utara',
            'Kab. Sumbawa', 'Kab. Sumbawa Barat',
        ],
        'Nusa Tenggara Timur' => [
            'Kupang',
            'Kab. Alor', 'Kab. Belu', 'Kab. Ende', 'Kab. Flores Timur', 'Kab. Kupang', 'Kab. Lembata',
            'Kab. Manggarai', 'Kab. Manggarai Barat', 'Kab. Manggarai Timur', 'Kab. Nagekeo', 'Kab. Ngada',
            'Kab. Rote Ndao', 'Kab. Sabu Raijua', 'Kab. Sikka', 'Kab. Sumba Barat', 'Kab. Sumba Barat Daya',
        ...
        'Kalimantan Barat' => [
            ...
            'Kab. Landak', 'Kab. Melawi', 'Kab. Mempawah', 'Kab. Sambas', 'Kab. Sanggau', 'Kab. Sekadau', 'Kab. Sintang',
        ],
        'Kalimantan Tengah' => [
            'Palangka Raya',
        ...
        'Kalimantan Selatan' => [
            ...
            'Kab. Hulu Sungai Utara', 'Kab. Kotabaru', 'Kab. Tabalong', 'Kab. Tanah Bumbu', 'Kab. Tanah Laut', 'Kab. Tapin',
        ],
        'Kalimantan Timur' => [
            'Samarinda', 'Balikpapan', 'Bontang',
            'Kab. Berau', 'Kab. Kutai Barat', 'Kab. Kutai Kartanegara', 'Kab. Kutai Timur', 'Kab. Mahakam Ulu',
            'Kab. Paser', 'Kab. Penajam Paser Utara',
        ],
        'Kalimantan Utara' => [
            'Tarakan',
        ...
        'Sulawesi Utara' => [
            ...
            'Kab. Minahasa Selatan', 'Kab. Minahasa Tenggara', 'Kab. Minahasa Utara',
        ],
        'Sulawesi Tengah' => [
            'Palu',
        ...
        'Sulawesi Selatan' => [
            ...
            'Kab. Maros', 'Kab. Pangkajene dan Kepulauan', 'Kab. Pinrang', 'Kab. Sidenreng Rappang', 'Kab. Sinjai',
            'Kab. Soppeng', 'Kab. Takalar', 'Kab. Tana Toraja', 'Kab. Toraja Utara', 'Kab. Wajo',
        ],
        'Sulawesi Tenggara' => [
            'Kendari', 'Bau-Bau',
        ...
        'Gorontalo' => [
            'Gorontalo',
            'Kab. Bone Bolango', 'Kab. Boalemo', 'Kab. Gorontalo', 'Kab. Gorontalo Utara', 'Kab. Pohuwato',
        ],
        'Sulawesi Barat' => [
            'Mamuju',
        ...
        'Papua' => [
            ...
            'Kab. Jayapura', 'Kab. Jayawijaya', 'Kab. Keerom', 'Kab. Kepulauan Yapen', 'Kab. Lanny Jaya', 'Kab. Mamberamo Raya',
            'Kab. Mamberamo Tengah', 'Kab. Mappi', 'Kab. Merauke', 'Kab. Mimika', 'Kab. Nabire', 'Kab. Nduga',
            'Kab. Paniai', 'Kab. Pegunungan Bintang', 'Kab. Puncak', 'Kab. Puncak Jaya', 'Kab. Sarmi', 'Kab. Supiori',
            'Kab. Tolikara', 'Kab. Waropen', 'Kab. Yahukimo', 'Kab. Yalimo',
        ],
        'Papua Barat' => [
            'Sorong', 'Manokwari',
